...
const mdxComponents = {
  ...
  h2: (props: ComponentPropsWithoutRef<"h2">) => {
    ...
    return (
      <h2
        id={id}
        className="mb-3 mt-6 scroll-mt-24 text-2xl font-semibold text-surface-100"
        {...props}
      />
    );
  },
  h3: (props: ComponentPropsWithoutRef<"h3">) => {
    ...
    return (
      <h3
        id={id}
        className="mb-2 mt-5 scroll-mt-24 text-xl font-semibold text-surface-100"
        {...props}
      />
    );
  },
  p: (props: ComponentPropsWithoutRef<"p">) => (
    <p
      className="my-3 leading-relaxed text-surface-200"
      {...props}
    />
  ),
  ul: (props: ComponentPropsWithoutRef<"ul">) => (
    <ul
      className="my-3 list-disc space-y-1 pl-6 text-surface-200"
      {...props}
    />
  ),
  ol: (props: ComponentPropsWithoutRef<"ol">) => (
    <ol
      className="my-3 list-decimal space-y-1 pl-6 text-surface-200"
      {...props}
    />
  ),
  ...
  strong: (props: ComponentPropsWithoutRef<"strong">) => (
    <strong
      className="font-semibold text-surface-50"
      {...props}
    />
  ),
  code: (props: ComponentPropsWithoutRef<"code">) => (
    <code
      className="rounded bg-surface-800 px-1.5 py-0.5 font-mono text-sm"
      {...props}
    />
  ),
  blockquote: (props: ComponentPropsWithoutRef<"blockquote">) => (
    <blockquote
      className="my-4 border-l-4 border-primary-700 pl-4 italic text-surface-200"
      {...props}
    />
  ),
};
