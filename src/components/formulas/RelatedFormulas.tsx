...
export function RelatedFormulas({ formulas }: RelatedFormulasProps) {
  ...
  return (
    <section className="mt-12 border-t border-surface-200 pt-8 dark:border-surface-700">
      <h2 className="mb-6 text-2xl font-bold text-surface-800 dark:text-surface-50">
