  ...
  if (formulas.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-center">
        <svg
          className="mb-4 h-16 w-16 text-surface-800/20 dark:text-surface-50/20"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1.5}
        ...
        <p className="text-lg font-semibold text-surface-800/60 dark:text-surface-50/60">
          Nenhuma fórmula encontrada
        </p>
        <p className="mt-1 text-sm text-surface-800/40 dark:text-surface-50/40">
